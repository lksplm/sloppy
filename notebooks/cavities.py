...
def Cav1L0Q(lens_dist=22.3, thet_fullOpen_deg=20, Rlens=5, lens_thick=4,  rExtraIntra=4.82, pathCorr=0.025, lens_diam=6.35,\
                  quart_thick=2., quartUW=False, quart2L=True):
    """
    ...
    # 'Manually' adjust optic positions so the thick lens bodies aren't hitting the mirrors
...
def Cav1L1QUW(lens_dist=22.3, thet_fullOpen_deg=20, Rlens=5, lens_thick=4,  rExtraIntra=4.82, pathCorr=0.025, lens_diam=6.35, c4=0., quart_thick=2.):
    """
...
def Cav1L2Q(
    ...
    # these 10 mm ROC parameters still don't quuuiiittteee agree with Mathematica yet
    ):
    """
